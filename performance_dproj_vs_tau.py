...
with open("performance_MSE_dproj_transync_alpha_ST_"+str(alpha)+".txt", "wb") as mse_proj:
    pickle.dump(MSE_proj, mse_proj)
with open("performance_data_dproj_transync_alpha_ST_"+str(alpha)+".txt", "wb") as Data_proj:
